...
def _uuid_value(value: uuid.UUID) -> str:
    return str(value)
...
class OrderRepository:
    ...
    async def save(self, order: Order) -> None:
        await self.session.execute(
            ...
            {
                "id": _uuid_value(order.id),
                "user_id": _uuid_value(order.user_id),
